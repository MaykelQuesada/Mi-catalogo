...
URL_SHEET = "https://docs.google.com/spreadsheets/d/1SA5BN6QT56xEyvK7cb3vuLFGPZDCG2oCgAuCkHf12qs/gviz/tq?tqx=out:csv&sheet=Catalogo"
...
try:
    ...
    # Filtros laterales
    st.sidebar.header("Filtrar contenido")
    ...
    st.error("Error: Asegúrate de que la hoja en Google Sheets se llame 'Catalogo' exactamente.")